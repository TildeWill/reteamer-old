class PersonSnapshotsController < ApplicationController
  before_action :set_person_snapshot, only: %i[ show edit update destroy ]

  # GET /person_snapshots or /person_snapshots.json
  def index
    @person_snapshots = PersonSnapshot.all
  end
